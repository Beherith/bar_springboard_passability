local unitName = 'units.names.armstump'
...
return {
	armstump = {
		...
		corpse = "DEAD",
		description = 'units.descriptions.armstump',
		energymake = 0.6,
		energyuse = 0.6,
		...
		customparams = {
			basename = "base",
			cannon1name = "cannon1",
			longdescription = 'units.longDescriptions.armstump',
			driftratio = "0.3",
